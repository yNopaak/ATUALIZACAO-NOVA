-- ROSES E TRIX SUAS PUTAS - Premium UI + ESP avançado + Auto-Return on Brainrot (Delta iOS/Android Fix)
...
titleLabel.Text = "ROSES E TRIX SUAS PUTAS"
...
proj.Text = "Projeto: ROSES E TRIX SUAS PUTAS (versão premium)"
...
-- quick notify
notify("ROSES E TRIX SUAS PUTAS carregado — painel premium pronto", 3.0)
